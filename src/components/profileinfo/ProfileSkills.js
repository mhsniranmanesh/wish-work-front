...
const ProfileSkills = (props) =>{
    ...
    if(props.Skills.translation_skill) {
        return (
            <div>
                                    ...
                                    <Col>
                                        <label>
                                            <input className="btn-radio" type="checkbox" name="rb" id="rb1"
                                                   checked={props.is_general} onChange={props.IsGeneral}/>
                                    ...
                                    <Col>
                                        <label>
                                            <input className="btn-radio" type="checkbox" name="rb" id="rb2"
                                                   checked={props.is_technical} onChange={props.IsTechnical}/>
                                    ...
                                    <Col>
                                        <label>
                                            <input className="btn-radio" type="checkbox" name="rb" id="rb3"
                                                   checked={props.is_medical} onChange={props.IsMedical}/>
                                    ...
                                    <Col>
                                        <label>
                                            <input className="btn-radio" type="checkbox" name="rb" id="rb4"
                                                   checked={props.is_legal} onChange={props.IsLaw}/>
