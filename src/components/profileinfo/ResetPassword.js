...
const ResetPassword = (props) =>{
  return(
      <div className="dash-con dash-profile-info con-body mb-4">
          <div className=" form-header-fontsize mb-3">
          ...
          <form className="">
              <div id="" className="form-group">
                  <input type="password" className="form-control form-control-danger detail-fontsize" id="" placeholder="رمز عبور فعلی"/>
                  {/*<div id="form-control-feedback-username" className="form-control-feedback" >رمز عبور فعلی صحیح نمیباشد!</div>*/}
              </div>
              <div id="" className="form-group">
                  <input type="password" className="form-control form-control-danger detail-fontsize" id="" placeholder="رمز عبور جدید"/>
              </div>
